...
**Enterprise / process architecture v2.0:** the unified roadmap (seven systems, data contracts, MCP, **indexed regex**, Phases 7–14) is **[IMPLEMENTATION-PLAN.md](IMPLEMENTATION-PLAN.md)**.
