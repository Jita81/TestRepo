...
**Master implementation plan (goals, status, agent phases, deploy):** [README.md](../README.md) · **Enterprise v2.0 alignment (phases 7–14):** [implementation-phase-plan-enterprise-v2.md](implementation-phase-plan-enterprise-v2.md)
